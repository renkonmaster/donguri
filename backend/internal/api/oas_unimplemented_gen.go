...
func (UnimplementedHandler) GetRoomIntersections(ctx context.Context, params GetRoomIntersectionsParams) (r *RoomIntersectionsResponse, _ error) {
	return r, ht.ErrNotImplemented
}
...
func (UnimplementedHandler) PutConnection(ctx context.Context, req *ConnectionRequest, params PutConnectionParams) (r *ConnectionResponse, _ error) {
	return r, ht.ErrNotImplemented
}
